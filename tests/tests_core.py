...
#         ({'partId': 'BBB'}, True)
#     ])
# def test_create_grader_from_create_grader_method(config, cli_parameters, debug):
...
def test_create_grader_default(config):
    ...
    assert grader.submission_type is None
    ...
    assert grader.solution_path == None
    assert grader.count_tests == None
...
def test_create_grader(config):
    ...
    grader = core.Grader(
        ...
        submission_type=submission_type, submission_filename=submission_filename,
    ...
    assert grader.solution_filename == config.solution_filename
    # check type default params
    assert grader.submission_type == submission_type
